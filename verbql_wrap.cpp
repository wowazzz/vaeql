...
/* header section */
ZEND_BEGIN_MODULE_GLOBALS(VerbQueryLanguage)
const char *error_msg;
int error_code;
ZEND_END_MODULE_GLOBALS(VerbQueryLanguage)
ZEND_DECLARE_MODULE_GLOBALS(VerbQueryLanguage)
#ifdef ZTS
#define SWIG_ErrorMsg() TSRMG(VerbQueryLanguage_globals_id, zend_VerbQueryLanguage_globals *, error_msg )
#define SWIG_ErrorCode() TSRMG(VerbQueryLanguage_globals_id, zend_VerbQueryLanguage_globals *, error_code )
#else
#define SWIG_ErrorMsg() (VerbQueryLanguage_globals.error_msg)
#define SWIG_ErrorCode() (VerbQueryLanguage_globals.error_code)
#endif

static void VerbQueryLanguage_init_globals(zend_VerbQueryLanguage_globals *globals ) {
  globals->error_msg = default_error_msg;
  globals->error_code = default_error_code;
}
static void VerbQueryLanguage_destroy_globals(zend_VerbQueryLanguage_globals * globals) { (void)globals; }
...
ZEND_NAMED_FUNCTION(_wrap_swig_VerbQueryLanguage_alter_newobject) {
  zval **args[2];
  swig_object_wrapper *value;
  int type;
  int thisown;
...
ZEND_NAMED_FUNCTION(_wrap_swig_VerbQueryLanguage_get_newobject) {
  zval **args[1];
  swig_object_wrapper *value;
  int type;
...
#define SWIG_name  "VerbQueryLanguage"
#ifdef __cplusplus
extern "C" {
#endif
#include "php.h"
...
#include "php_VerbQueryLanguage.h"
#ifdef __cplusplus
}
#endif
...
static void __wrap_delete_VerbQueryLanguage(zend_rsrc_list_entry *rsrc, const char *type_name TSRMLS_DC) {
  ...
  arg1 = (VerbQueryLanguage *)SWIG_ZTS_ConvertResourceData(ptr,type_name,SWIGTYPE_p_VerbQueryLanguage TSRMLS_CC);
  if (! arg1) zend_error(E_ERROR, "VerbQueryLanguage resource already free'd");
  delete arg1;
  return;
fail:
  zend_error_noreturn(SWIG_ErrorCode(),"%s",SWIG_ErrorMsg());
...
zend_module_entry* SWIG_module_entry = &VerbQueryLanguage_module_entry;

#ifdef __cplusplus
extern "C" {
#endif
SWIGEXPORT zend_module_entry *get_module(void) { return &VerbQueryLanguage_module_entry; }
#ifdef __cplusplus
}
#endif

#define SWIG_php_minit PHP_MINIT_FUNCTION(VerbQueryLanguage)
/* -----------------------------------------------------------------------------
 * Type initialization:
...
/* shutdown section */
#ifdef ZTS
    ts_free_id(VerbQueryLanguage_globals_id);
#endif
    return SUCCESS;
}
